    ...
    <div class="query-form">
      <el-form :inline="true" :model="queryForm" ref="form">
        ...
        <el-form-item label="菜单状态" prop="menuState">
          <el-select v-model="queryForm.menuState" style="width: 80px">
...
export default {
  ...
  methods: {
    async getMenuList(menuForms = this.menuForm) {
      const res = await this.$api.menuList(menuForms);
      this.menuList = res;
    },
    handleQuery() {
    ...
    async handleDelete(_id) {
      const data = await this.$api.menuSubmit({ _id, action: "delete" });
      console.log("object dele", data);
