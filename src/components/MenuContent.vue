<template>
  <template v-for="menuItem in userMenu">
    <el-sub-menu
      v-if="
        menuItem.children &&
        menuItem.children.length > 0 &&
        menuItem.children[0].menuType == 1
      "
      :key="menuItem._id"
      :index="menuItem.path"
    >
      ...
      <menu-content :userMenu="menuItem.children"></menu-content>
    </el-sub-menu>
    <el-menu-item v-else-if="menuItem.menuType == 1" :index="menuItem.path">
      {{ menuItem.menuName }}
    </el-menu-item>
  </template>
</template>
...
export default {
  ...
  mounted() {
    console.log("object menu", this.userMenu);
  },
};
</script>
